...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Ensure content fields are displayed inline with icons
    document.querySelectorAll('.cont-details p').forEach(function (p) {
        p.style.display = 'flex';
        p.style.alignItems = 'center';
    });

    document.querySelectorAll('.cont-details p i').forEach(function (icon) {
