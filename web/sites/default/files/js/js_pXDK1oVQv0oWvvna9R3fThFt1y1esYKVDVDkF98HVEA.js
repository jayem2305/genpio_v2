...
document.addEventListener("DOMContentLoaded", function() {
    let dateElement = document.querySelector(".views-field-field-event-date .field-content");
    
    if (dateElement) {
        let dateText = dateElement.innerText.trim(); // Get text
        ...
        // Update HTML to match the desired format
        dateElement.innerHTML = `<div class="event-date"><span class="event-day">${day}</span><br><span class="event-month-year">${month} ${year}</span></div>`;
    }
});
