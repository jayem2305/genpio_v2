        ...
        attach: function (context, settings) {
            $("h3", context).each(function () {
                ...
                if (text.includes("Event") || text.includes("News")) {
                    ...
                    // Find the parent container and append the button below the card
                    var $parentContainer = $this.closest(".news-card-container");

                    if ($parentContainer.length && !$parentContainer.find(".see-more-wrapper").length) {
                        $parentContainer.append('<div class="see-more-wrapper"><a href="' + targetUrl + '" class="see-more-btn">SEE MORE ' + text.toUpperCase() + ' <span>➜</span></a></div>');
                    }
